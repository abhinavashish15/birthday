...
export default function Home() {
  ...
  const handleLetsGo = () => {
    ...
    // Ensure music is playing when user clicks Let's Go
    playMusic();
  };
          ...
          [...Array(15)].map((_, i) => {
            const roses = [
              ...
              }, // Pink rose
              {
                ...
                shadow: "rgba(251, 207, 232, 0.6)",
              }, // Light pink rose
              {
                emoji: "🌹",
                color: "rgba(254, 240, 138, 0.9)",
                shadow: "rgba(254, 240, 138, 0.6)",
              }, // Yellow rose
              {
                emoji: "🌹",
        ...
        {showWelcome ? (
          ...
          >
            ...
            <motion.div
              ...
              style={{
                boxShadow:
                  "0 25px 50px -12px rgba(236, 72, 153, 0.5), 0 0 0 1px rgba(236, 72, 153, 0.1)",
              }}
              initial={{ y: 50 }}
              animate={{ y: 0 }}
              ...
              <div className="relative z-10">
                ...
                >
                  <motion.span
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, #ec4899, #f97316, #eab308, #ec4899)",
                ...
                >
                  <motion.span
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, #8b5cf6, #ec4899, #f472b6, #8b5cf6)",
                      backgroundSize: "200% 200%",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                ...
                <motion.button
                  ...
                  whileHover={{
                    scale: 1.15,
                    boxShadow:
                      "0 20px 60px rgba(236, 72, 153, 0.9), 0 0 40px rgba(236, 72, 153, 0.7)",
                  }}
                  whileTap={{ scale: 0.95 }}
                >
                  {/* Shimmer effect */}
            ...
            >
              ...
              >
                <motion.span
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #ffffff, #fef3c7, #fde047, #fef3c7, #ffffff)",
                ...
                <motion.span
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #fde047, #f59e0b, #fbbf24, #fde047)",
                    backgroundSize: "300% 300%",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    bgGradient:
                      "linear-gradient(135deg, rgba(236, 72, 153, 0.1), rgba(251, 113, 133, 0.1))",
                    borderGlow: "#ec4899",
                  },
                  {
                    href: "/cake",
                  ...
                  <Link href={item.href} key={item.href}>
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl ${item.color} opacity-5 rounded-bl-full`}
                        />
                        <div
                          className={`absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr ${item.color} opacity-5 rounded-tr-full`}
                        />
